...
$( document ).ready(function() {
    var data = $('#secretAllData').html();
    $("#searchStudents").html(data);
...
function searchStudent()
{
    ...
    if (studentName == '') {
        ...
        if (oneDown) {
            var link = "../searchStudent/"+studentName;
        } else {
            var link = "searchStudent/"+studentName;
        }
