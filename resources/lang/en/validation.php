...
return [
    ...
    */
    ...
    'digits' => 'De `:attribute` moet :digits karakters zijn.',
    'digits_between' => 'De `:attribute` moet tussen de :min en :max karakters zijn.',
    'dimensions' => 'De dimensies van `:attribute` kloppen niet.',
    'distinct' => 'De `:attribute` heeft een dubbele value.',
    'email' => 'De :attribute moet een e-mail adres zijn.',
    ...
    'gt' => [
        ...
        'string' => 'De `:attribute` moet meer zijn dan :value karakters.',
    ...
    'gte' => [
        ...
        'string' => 'De `:attribute` moet meer of gelijk aan :value karakters zijn.',
    ...
    'lte' => [
        ...
        'string' => 'De `:attribute` moet minder of gelijk aan zijn dan :value karakters.',
    ...
    'max' => [
        ...
        'string' => 'De `:attribute` mag niet meer zijn dan :max karakters.',
    ...
    'not_in' => 'De geselecteerde `:attribute` klop(t)(pen) niet.',
    ...
    'size' => [
        ...
        'string' => 'The :attribute must be :size karakters.',
